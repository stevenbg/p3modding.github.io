...
## Sailor Reputation
A merchant's sailor reputation is stored at `0x1f`. Unlike his standing with the
[population](./reputation.md), which is kept per town, this is a single value covering the
whole world. It influences the growth or decline of the sailor pools.
